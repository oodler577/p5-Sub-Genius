...
to a program that is expressed in a L<Sub::Genius> facilitated program?

=item * Are there fundamental capabilities the C<perl> runtime can provide
to make the model presented by <Sub::Genius>? For example, TEODESIAN
